...
WriteLine(FirstNumber * FirstNumber == SecondNumber ? "Второе число является квадратом первого" : SecondNumber * SecondNumber == FirstNumber ? "Первое число явялется квадратом второго" : "NO!");
